...
config["postgis"]["host"]     = ""
config["postgis"]["port"]     = ""
config["postgis"]["dbname"]   = "puerto_rico_osm"
config["postgis"]["user"]     = ""
...
config["land-high"] = path.join(getcwd(),"shp/downloads/land-polygons-split-3857/land_polygons.shp")
config["land-low"] = path.join(getcwd(),"shp/downloads/simplified-land-polygons-complete-3857/simplified_land_polygons.shp")
